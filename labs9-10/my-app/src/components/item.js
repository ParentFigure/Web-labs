...
function Item() {
    ...
    const [selectedType, setSelectedType] = useState("Type of record");
    const [selectedPower, setSelectedPower] = useState("Bonuses");
                ...
                <div className="item-selects">
                    ...
                    <div className="item-select">
                        ...
                        <Select className="select" value={selectedPower} onChange={handleChangePower} onCountChange={setCount}>
                            <Select.Option value="personal bonuses">personal bonuses</Select.Option>
                            <Select.Option value="today's discounts">today's discounts</Select.Option>
